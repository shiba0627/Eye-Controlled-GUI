...
class GUIApp():
    def __init__(self):
        ...
        button_list = [
            (FORWARD, FORWARD_ACTIVE, FORWARD_LOCK, FORWARD_ATTENTION, 1/4, 1/6, 'w'),
        ...
        for img_path, dark_path, lock_path, attention_path, center_x_ratio, center_y_ratio, char in button_list:
            ...
            self.buttons.append(makeButton(self.canvas, img_path, dark_path, lock_path, attention_path, area, char))
