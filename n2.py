...
class GameFrame(BaseFrame):# 操作画面
    def __init__(self, master = None, app_instance = None):
        ...
        button_list = [
    (ONE,   ONE_ATTENTION,   SELECTED, 2/3, 1/4, 1),
    (TWO,   TWO_ATTENTION,   SELECTED, 1/2, 1/2, 2),
    (THREE, THREE_ATTENTION, SELECTED, 2/3, 1/2, 3),
    (FOUR,  FOUR_ATTENTION,  SELECTED, 1/3, 1/4, 4),

    (FIVE,  FIVE_ATTENTION,  SELECTED, 1/3, 1/2, 5),

    (SIX,   SIX_ATTENTION,   SELECTED, 1/2, 3/4, 6),
    (SEVEN, SEVEN_ATTENTION, SELECTED, 2/3, 3/4, 7),
    (EIGHT, EIGHT_ATTENTION, SELECTED, 1/3, 3/4, 8),

    (NINE,  NINE_ATTENTION,  SELECTED, 1/2, 1/4, 9),
